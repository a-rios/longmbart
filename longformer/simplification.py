...
class Simplifier(pl.LightningModule):
    ...
    def add_model_specific_args(parser, root_dir):
        ...
        parser.add_argument("--test_source", type=str, default=None, help="Path to the source test file (evaluate after training is finished).")
        parser.add_argument("--test_target", type=str, default=None, help="Path to the target test file (evaluate after training is finished).")
